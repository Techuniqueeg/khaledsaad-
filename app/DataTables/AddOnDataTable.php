...
class AddOnDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        return datatables()
            ->eloquent($query)
            ->addColumn('action', 'dashboard.addon.parts.action')
            ->rawColumns(['action']);
    }
     ...
     */
    public function query(AddOn $model)
    {
